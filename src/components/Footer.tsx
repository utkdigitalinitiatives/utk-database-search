...
const Footer = () => {
    ...
    return (
        <footer className="mt-auto grid grid-cols-1 md:grid-cols-2 gap-2 bg-utk-light-gray pt-4 shadow-inner">
            ...
            <div className="grid row-start-2 sm:row-start-auto grid-cols-1 grid-rows-2 lg:py-1">
                <form id="utk_seek" method="GET" action="https://search.utk.edu/search" className='flex justify-center px-2 h-9'>
                    ...
                    }} placeholder="Search utk.edu" className="form-control shadow-inner border-s-2 border-y-2 focus:border-utk-orange focus:outline-hidden p-1 rounded-l-md md:w-96 " title="search" />
