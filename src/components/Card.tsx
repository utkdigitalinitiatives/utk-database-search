...
const Card = ({ dbName, endpoint, summary, imgSrc }: { dbName: string, endpoint: string, summary: string, imgSrc: string, }) => {
    return (
        <Link to={endpoint} className="px-3">
            <figure className="lg:flex rounded-xl border-2 border-utk-light-gray p-8 md:p-0 hover:border-utk-orange hover:bg-utk-light-gray ease-in-out duration-300">
