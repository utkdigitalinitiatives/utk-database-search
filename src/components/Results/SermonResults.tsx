                            ...
                            return (
                                <div className="flex flex-col px-2" key={`${result[config.idField]}-${field.key}`}>
                                    <div className="flex flex-wrap">
                                        <span className="font-semibold px-2">{field.label}:</span>
                                        <div className="text-wrap">{field.render(value)}</div>
                                    </div>
                                </div>
                            );
                        }
